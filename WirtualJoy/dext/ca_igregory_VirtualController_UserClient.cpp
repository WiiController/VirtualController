...
#include "ca_igregory_VirtualController_UserClient.h"
#include "ca_igregory_VirtualController.h"
#include "ca_igregory_VirtualController_Device.h"

struct ca_igregory_VirtualController_UserClient_IVars {
    ca_igregory_VirtualController_Device *_device;
...
{
    {
        (IOUserClientMethodFunction)ca_igregory_VirtualController_UserClient::_enableDevice,
    ...
    {
        (IOUserClientMethodFunction)ca_igregory_VirtualController_UserClient::_disableDevice,
        0, 0, 0, 0, 0
    },
    
    {
        (IOUserClientMethodFunction)ca_igregory_VirtualController_UserClient::_updateDeviceState,
        0, 0, kIOUserClientVariableStructureSize, 0, 0
    },
    
    {
        (IOUserClientMethodFunction)ca_igregory_VirtualController_UserClient::_setDeviceProductString,
        0, 0, kIOUserClientVariableStructureSize, 0, 0
    },
    
    {
        (IOUserClientMethodFunction)ca_igregory_VirtualController_UserClient::_setDeviceSerialNumberString,
        0, 0, kIOUserClientVariableStructureSize, 0, 0
    },
    
    {
        (IOUserClientMethodFunction)ca_igregory_VirtualController_UserClient::_setDeviceVendorAndProductID,
        0, 0, kIOUserClientVariableStructureSize, 0, 0
    }
};
...
kern_return_t ca_igregory_VirtualController_UserClient::_enableDevice(ca_igregory_VirtualController_UserClient *target, void *reference, IOUserClientMethodArguments *args)
{
    return target->enableDevice(args->structureInput);
}

kern_return_t ca_igregory_VirtualController_UserClient::_disableDevice(ca_igregory_VirtualController_UserClient *target, void *reference, IOUserClientMethodArguments *args)
{
    return target->disableDevice();
}

kern_return_t ca_igregory_VirtualController_UserClient::_updateDeviceState(ca_igregory_VirtualController_UserClient *target, void *reference, IOUserClientMethodArguments *args)
{
    return target->updateDeviceState(args->structureInput);
}

kern_return_t ca_igregory_VirtualController_UserClient::_setDeviceProductString(ca_igregory_VirtualController_UserClient *target, void *reference, IOUserClientMethodArguments *args)
{
    return target->setDeviceProductString(args->structureInput);
}

kern_return_t ca_igregory_VirtualController_UserClient::_setDeviceSerialNumberString(ca_igregory_VirtualController_UserClient *target, void *reference, IOUserClientMethodArguments *args)
{
    return target->setDeviceSerialNumberString(args->structureInput);
}

kern_return_t ca_igregory_VirtualController_UserClient::_setDeviceVendorAndProductID(ca_igregory_VirtualController_UserClient *target, void *reference, IOUserClientMethodArguments *args)
{
...
void
ca_igregory_VirtualController_UserClient::free()
{
    ...
    IODelete(ivars, ca_igregory_VirtualController_UserClient_IVars, 1);
    super::free();
}
...
// LOCALONLY
kern_return_t
ca_igregory_VirtualController_UserClient::ExternalMethod(
    uint64_t selector,
...
ca_igregory_VirtualController_UserClient::enableDevice(OSData *hidDescriptorData)
{
    ...
    ivars->_device = ca_igregory_VirtualController_Device::withHidDescriptor(
        this,
...
kern_return_t
ca_igregory_VirtualController_UserClient::updateDeviceState(OSData *hidReportData)
{
...
kern_return_t ca_igregory_VirtualController_UserClient::setDeviceProductString(OSData *productStringData)
{
...
kern_return_t ca_igregory_VirtualController_UserClient::setDeviceSerialNumberString(OSData *serialNumberStringData)
{
    if (ivars->_device) return kIOReturnBusy;
...
kern_return_t ca_igregory_VirtualController_UserClient::setDeviceVendorAndProductID(uint32_t vendorID, uint32_t productID)
{
    if (ivars->_device) return kIOReturnBusy;
