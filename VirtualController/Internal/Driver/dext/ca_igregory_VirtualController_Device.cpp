...
struct ca_igregory_VirtualController_Device_IVars {
    // Must never be null.
...
// LOCALONLY
OSDictionary *
ca_igregory_VirtualController_Device::newDeviceDescription()
{
    struct KV {
        char const *key;
        OSObject *value;
        ...
        },
        {
            ...
            OSString::withCString("VirtualController")
        },
        {
...
// LOCALONLY
OSData *
ca_igregory_VirtualController_Device::newReportDescriptor()
{
...
initDevice(
    ca_igregory_VirtualController_Device_IVars *ivars,
...
ca_igregory_VirtualController_Device*
ca_igregory_VirtualController_Device::withHidDescriptor(
    IOService *provider,
    ...
    auto device = OSRequiredCast(ca_igregory_VirtualController_Device, newService);
...
bool
ca_igregory_VirtualController_Device::updateState(const void *hidData, size_t hidDataSize)
{
